...
class Origin():
    ...
    def avatar(self, userid):
        url = f"https://secure.download.dm.origin.com/production/avatar/prod/userAvatar/{userid}/416x416.JPEG"
...
print(origin.get_userid())

print(origin.games("2258446805"))
